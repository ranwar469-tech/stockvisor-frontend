    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 dark:bg-slate-800 p-6 rounded-lg border border-blue-600 shadow-lg">
            <h3 className="text-2xl font-bold text-blue-500 dark:text-blue-300 mb-3">Our Mission</h3>
          ...
          <div className="bg-blue-50 dark:bg-slate-800 p-6 rounded-lg border border-blue-600 shadow-lg">
            <h3 className="text-2xl font-bold text-blue-500 dark:text-blue-300 mb-3">Key Features</h3>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-900 p-6 rounded-lg shadow-lg">
            ...
            <button className="bg-white dark:bg-slate-900 hover:bg-gray-100 dark:hover:bg-slate-800 text-blue-400 dark:text-blue-400 font-bold py-2 px-6 rounded transition-colors">
              Launch Dashboard
            </button>
          </div>
        </div>
