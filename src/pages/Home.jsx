  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-slate-400 mb-8">Track your favorite stocks in real-time</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-700 p-6 rounded-lg border border-blue-600 shadow-lg">
            <p className="text-slate-300 text-sm">Today's Gain/Loss</p>
            <p className="text-3xl font-bold text-green-400 mt-2">+$1,245.32</p>
          </div>
          <div className="bg-gradient-to-br from-slate-800 to-slate-700 p-6 rounded-lg border border-blue-600 shadow-lg">
            <p className="text-slate-300 text-sm">Total Return</p>
        ...
        <div className="bg-slate-800 rounded-lg border border-blue-600 shadow-lg overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {stocks.map((stock) => (
                  <tr key={stock.symbol} className="border-b border-slate-700 hover:bg-slate-700 transition-colors">
                    <td className="p-4 font-bold text-blue-400">{stock.symbol}</td>
                    <td className="p-4 text-slate-300">{stock.name}</td>
                    <td className="text-right p-4 font-semibold text-white">${stock.price.toFixed(2)}</td>
